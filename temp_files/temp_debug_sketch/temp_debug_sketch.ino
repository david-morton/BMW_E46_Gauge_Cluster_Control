...
// This is put here so i can simply move it around via Github and program into
// the car via my old laptop. Its used to pull CAN data for debug off one of the
// shields via the CANHacker software etc.

// Its based off the Seeed Studio example file 'canbus-monitor'
...
void setup() {
  ...
  // Rates: CAN_10KBPS, CAN_20KBPS, CAN_50KBPS, CAN_100KBPS, CAN_125KBPS, CAN_250KBPS, CAN_500KBPS, CAN_800KBPS,
  ...
  Can232::init(CAN_500KBPS, MCP_16MHz); // set default rate you need here and clock frequency of CAN shield. Typically
                                        // it is 16MHz, but on some MCP2515 + TJA1050 it is 8Mhz
